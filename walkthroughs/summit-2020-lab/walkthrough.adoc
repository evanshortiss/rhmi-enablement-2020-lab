...
. Select the *Modern Webapp* (JS icon) under *Builder Image*.
. Select 10.x under the *Builder Image Version* dropdown.
...
spec:
  ...
  source:
    git:
      uri: 'https://github.com/evanshortiss/rhmi-enablement-2020-lab'
      ref: master
